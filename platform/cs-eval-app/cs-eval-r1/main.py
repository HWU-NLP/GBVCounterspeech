...
task = st.Page("annotation_db.py", title="🔴 Start Task")
...
def give_consent():
    ...
    **Study title:** Structured Gender-Based Violence and Counterspeech
    ...
    Yes. The project has been approved by our institution ethics committee.
    """) 
    ...
    In **<GBV Counterspeech Evaluation Task>**: you need to complete the evaluation questions for a portion of the gender-based hate speech and its generated counterspeech responses.
    """)
