...
class SourceDataset(Base):
    ...
    cs_prompting_0 = Column(String, nullable=False)
    cs_strategy_single = Column(String, nullable=False)
    cs_strategy_multi = Column(String, nullable=False)
    cs_strategy_form = Column(String, nullable=False)
    cs_strategy_form_target = Column(String, nullable=False)
    ...
    with Session(engine) as session:
        for _, row in df.iterrows():
            ...
            new_row = SourceDataset(
                ...
                cs_prompting_0=row['cs_prompting_0'],
                cs_strategy_single=row['cs_strategy_single'],
                cs_strategy_multi=row['cs_strategy_multi'],
                cs_strategy_form=row['cs_strategy_form'],
                cs_strategy_form_target=row['cs_strategy_form_target'],
            )
