...
def give_consent():
    ...
    **Study title:** Structured Gender-Based Violence and Counterspeech
    ...
    You have been invited to participate as you are a highly qualified worker on Prolific.
    """)

    st.markdown("""
    🔹 **Do I have to take part?**
    
    Taking part is voluntary. You may choose not to take part or to decide to stop taking part at any time without giving a reason.
    """)
    ...
    If you participant in **<GBV Counterspeech Annotation Task>**:
    1. Label a portion of the dataset that contains instances of gender-based hate speech and their corresponding counterspeech responses.    
    2. Read each counterspeech response to the original GBV text and determine the strategy and the audience used to counter the gender-based hate speech.
    3. Participate in a feedback session where you may be asked to provide your thoughts and experiences regarding the labelling process.
    """)

    st.markdown("""
    🔹 **What are the benefits of participating in this study?**
    
    You will be paid at least the UK Living Wage per hour for participating in this part of the study.
    
    You will be paid for your time regardless of whether you complete the study.
    """)

    st.markdown("""
    🔹 **What will happen if I don’t wish to carry on with the study?**
    
    If you decide that you no longer wish to take part, you can withdraw at any time without giving a reason.
    """)
