...
class SourceDataset(Base):
    ...
    counterspeech = Column(String, nullable=False)
    gbv_id = Column(Integer, nullable=False)
...
class AnnotationRecord(Base):
    ...
    cs_target = Column(String, default='')
...
def load_source_data(file_path: str, engine):
    ...
    required_columns = {"pair_id", "gbv", "counterspeech", "gbv_id"}
